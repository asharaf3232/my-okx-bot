// =================================================================
// Advanced Analytics Bot - v117 (Stable Text-Only Performance Report)
// =================================================================
...
bot.command("fixdb", async (ctx) => {
    ...
    try {
        ...
        for (let i = 30; i >= 0; i--) {
            ...
            mockDailyHistory.push({ date: date.toISOString().slice(0, 10), total: 5000 + Math.random() * 500 });
        }
        const mockHourlyHistory = [];
        for (let i = 72; i >= 0; i--) {
            const date = new Date();
            date.setHours(date.getHours() - i);
            mockHourlyHistory.push({ label: date.toISOString().slice(0, 13), total: 5000 + Math.random() * 500 });
        }
