// =================================================================
// Advanced Analytics Bot - v117 (PNL Calculation & Reporting Fix)
// =================================================================
...
// =================================================================
// SECTION 4: BACKGROUND JOBS & DYNAMIC MANAGEMENT (PNL LOGIC CORRECTED)
// =================================================================
async function updatePositionAndAnalyze(asset, amountChange, price, newTotalAmount, oldTotalValue) {
    ...
    if (amountChange > 0) { // Buy
        ...
        if (newTotalAmount * price < 1) { // --- POSITION CLOSED ---
            ...
            // Only save the fully closed trade to history
            ...
            // We no longer save partial sells to the history to keep the daily report clean.
            // The position object itself is updated and saved, which is enough.
        }
    }
...
// =================================================================
// SECTION 4.5: DAILY COPY-TRADING REPORT
// =================================================================
async function formatDailyCopyReport() {
    ...
    for (const trade of closedTrades) {
        // Skip any trades that might not have the required data (older ones)
